                    ...
                    <div class="SingleProperty-social">
                        ...
                        <ul class="Social-actions">
                            ...
                            <li class="social-actions__item">
                                ...
                                <a href="mailto:?subject=<?php echo $listing->address->full; ?>&body=<?php echo 'I thought you might be interested in this property: ' . get_bloginfo( 'url' ) . '/listings/' . $listing->mlsId . '/' . $mailAddress; ?>" rel="noreferrer noopener" target="_blank">
                                    <span>
                                        <svg version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <!--Generated by IJSVG (https://github.com/curthard89/IJSVG)-->
                                            <g fill="#000000">
